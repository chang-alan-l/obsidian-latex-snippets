[
    ...
    {trigger: "after", replacement: "\\circ", options: "mA"},
    {trigger: "implies", replacement: "\\Rightarrow", options: "mA"},
    ...
    {trigger: "mfra", replacement: "\\mathfrak{$0}$1", options: "mA"},
    ...
    // Integrals
    {trigger: "oinf", replacement: "\\int_{0}^{\\infty} $0 \\mathop{\\mathrm d${1:x} $2}", options: "mA"},
    {trigger: "infi", replacement: "\\int_{-\\infty}^{\\infty} $0 \\mathop{\mathrm d${1:x} $2}", options: "mA"},
    {trigger: "dint", replacement: "\\int_{${0:0}}^{${1:\\infty}} $2 \\mathop{\\mathrm d${3:x} $4}", options: "mA"},
    {trigger: "oint", replacement: "\\oint", options: "mA"},
    {trigger: "iiint", replacement: "\\iiint", options: "mA"},
    {trigger: "iint", replacement: "\\iint", options: "mA"},
    {trigger: "int", replacement: "\\int $0 \\mathop{\\mathrm d${1:x} $2}", options: "mA"},


    // Category Theory
    {trigger: "copro", replacement: "\\Large{\\amalg}_{$0} $1", options: "mA"},
    ...
    // Statistics
    {trigger: "E", replacement: "\\mathbb E", options: "m"},
